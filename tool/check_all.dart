...
Future<void> main() async {
  final checks = <_Check>[
    ...
    const _Check(
      ...
      'dart',
      ['run', 'tool/check_complexity_budget.dart'],
    ),
    const _Check(
      'check_dependency_rules',
      'dart',
      ['run', 'tool/check_dependency_rules.dart'],
    ),
    const _Check(
      'check_named_routes',
      'dart',
      ['run', 'tool/check_named_routes.dart'],
    ),
    const _Check(
      'check_route_paths',
      'dart',
      ['run', 'tool/check_route_paths.dart'],
    ),
    const _Check(
      'check_route_names',
      'dart',
      ['run', 'tool/check_route_names.dart'],
    ),
    const _Check(
      'check_route_name_usage',
      'dart',
      ['run', 'tool/check_route_name_usage.dart'],
    ),
    const _Check(
      'check_composable_system',
      'dart',
      ['run', 'tool/check_composable_system.dart', '--strict'],
    ),
    const _Check(
      'check_nesting_depth',
      'dart',
      ['run', 'tool/check_nesting_depth.dart'],
    ),
    const _Check(
      'check_directionality',
      'dart',
      ['run', 'tool/check_directionality.dart'],
    ),
    const _Check(
      'check_copy_contract',
      'dart',
      ['run', 'tool/check_copy_contract.dart'],
    ),
    const _Check(
      'check_shared_understanding_copy',
      'dart',
    ...
    const _Check(
      'check_no_prints',
      'dart',
      ['run', 'tool/check_no_prints.dart'],
    ),
    const _Check(
      'check_no_direct_supabase_http',
      'dart',
      ['run', 'tool/check_no_direct_supabase_http.dart'],
    ),
    const _Check(
      'check_no_raw_material',
      'dart',
      ['run', 'tool/check_no_raw_material.dart'],
    ),
    const _Check(
      'check_no_platform_logic',
      'dart',
      ['run', 'tool/check_no_platform_logic.dart'],
    ),
    const _Check(
      'check_no_public_invite_join_endpoints',
      'dart',
      ['run', 'tool/check_no_public_invite_join_endpoints.dart'],
    ),
    const _Check(
      'check_no_direct_writes',
      'dart',
      ['run', 'tool/check_no_direct_writes.dart'],
    ),
    const _Check(
      'check_no_raw_gestures',
      'dart',
      ['run', 'tool/check_no_raw_gestures.dart'],
    ),
    const _Check(
      'check_di_wiring',
      'dart',
      ['run', 'tool/check_di_wiring.dart'],
    ),
    const _Check('check_colors', 'bash', ['tool/check_colors.sh']),
    const _Check(
      'check_theme_tokens',
      'dart',
      ['run', 'tool/check_theme_tokens.dart'],
    ),
    const _Check(
      'check_modules',
      'dart',
      ['run', 'tool/check_modules.dart'],
    ),
  ];
