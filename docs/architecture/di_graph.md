```mermaid
graph LR
  subgraph main_grp [main]
    main_dart["main.dart"]
  end
  subgraph app_grp [app]
    app_di["app.di"]
    app_router["app.router"]
  end
  subgraph foundation_grp [foundation]
    foundation_registry["foundation.registry"]
    foundation_surfaces["foundation.surfaces"]
  end
  subgraph features_grp [features]
  ...
  subgraph contracts_grp [contracts]
  ...
  subgraph generated_grp [generated]
    generated["generated"]
  end
  subgraph renderer_grp [renderer]
    renderer["renderer"]
  end
  app_di --> core_di
