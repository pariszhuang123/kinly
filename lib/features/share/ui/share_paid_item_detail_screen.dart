...
class SharePaidItemDetailScreen extends StatelessWidget {
  const SharePaidItemDetailScreen({
    super.key,
    required this.item,
  });
  ...
  Widget build(BuildContext context) {
    ...
    final heroTag = 'share-paid-photo-${item.expenseId}-${photoUrl.hashCode}';
