...
const _expenseCodeMap = <String, ExpenseErrorCode>{
  ...
  'INVALID_ALLOCATION_TARGET': ExpenseErrorCode.invalidAllocationTarget,
  ...
  'INVALID_SPLITS': ExpenseErrorCode.invalidSplits,
  'INVALID_SPLITS_SUM': ExpenseErrorCode.invalidSplitsSum,
  'SPLIT_MEMBERS_REQUIRED': ExpenseErrorCode.splitMembersRequired,
  'SPLIT_UNITS_REQUIRED': ExpenseErrorCode.splitUnitsRequired,
  'INVALID_DEBTOR': ExpenseErrorCode.invalidDebtor,
  'INVALID_UNIT_TARGET': ExpenseErrorCode.invalidUnitTarget,
  ...
  'PHOTO_DELETE_NOT_ALLOWED': ExpenseErrorCode.photoDeleteNotAllowed,
